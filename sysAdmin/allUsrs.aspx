...
<p>
     ...
     <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="user_id" DataSourceID="allusersDS" ForeColor="#666666" GridLines="None" CssClass="table table-striped table-bordered table-condensed table-hover table-responsive pull-right animated flipInX top col-sm-10"  Font-Italic="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
